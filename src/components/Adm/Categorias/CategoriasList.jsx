...
function CategoriasList({
  ...
  return (
    <>
      <div
        className={`bg-[#ffffff] w-[100%] shadow-lg m-3 p-5 ${
      ...
      >
        ...
        {!dt_exclusao ? (
          <>
            {!dt_inativacao ? (
              <>
                <Link
                  ...
                  to={`/admin/categorias/editar/${id_categoria}`}
                >
                  Editar
                </Link>

                <button
                  onClick={() => handleDesativar(id_categoria)}
                ...
                <button
                  onClick={() => handleDelete(id_categoria)}
            ...
            {dt_inativacao ? (
              <button
                onClick={() => handleAtivar(id_categoria)}
